...
<body>
    <div class="header">
        ...
        <p>Dicetak Tanggal: {{ $date ?? date('d F Y') }}</p>
    </div>
                    ...
                    <div class="two-column">
                        <div class="column-left">
                            ...
                            <div class="data-row">
                                ...
                                <div class="data-value">: {{ $p->tempat_lahir ?? '-' }},
                ...
                <div class="section">
                    ...
                    <div class="section-content">
                        <div class="data-row">
                            ...
                            <div class="data-value">: Rp
                                {{ isset($p->phdp) ? number_format($p->phdp, 0, ',', '.') : '-' }}</div>
                        </div>
                                ...
                                @foreach ($keluargaData as $index => $keluarga)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{ $keluarga->tanggal_lahir ? \Carbon\Carbon::parse($keluarga->tanggal_lahir)->format('d-m-Y') : '-' }}
                                        </td>
