        ...
        <div class="dashboard-container">
            <div class="dashboard-header">
                <h1 class="dashboard-title">
                    <i class="fas fa-building me-2"></i> Tabel Nilai Sekarang
                </h1>
                <div>
                    <a href="{{ route('admin.parameter.ns.create') }}" class="btn btn-primary action-button">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex">
                                                <a href="{{ route('admin.parameter.ns.edit', $nilaiSekarang->id) }}"
                                                    class="btn btn-sm btn-warning me-2">
                                                    <i class="fas fa-edit"></i> Edit
                                                </a>
                                                <form
                                                    action="{{ route('admin.parameter.ns.destroy', $nilaiSekarang->id) }}"
                                                    method="POST"
