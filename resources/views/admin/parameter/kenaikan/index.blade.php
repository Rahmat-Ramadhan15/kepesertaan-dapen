        ...
        <section id="content" class="content">
            <div class="content__header content__boxed overlapping">
                <div class="content__wrap">
                    ...
                    <h1 class="page-title mb-2">Tabel Kenaikan</h1>
                    <!-- END : Page title and information -->
                    <!-- Breadcrumb -->
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">Kenaikan</li>
                        </ol>
                    </nav>
                    <!-- END : Breadcrumb -->
                </div>
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                                    ...
                                    <!-- Tombol Add New -->
                                    <a href="{{ route('admin.parameter.kenaikan.create') }}"
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($kenaikan as $nilai_kenaikan)
                                            <tr>
                                                <td class="fw-semibold">{{ $nilai_kenaikan->jabatan }}</td>
                                                <td>
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <span>{{ $nilai_kenaikan->kenaikan }}</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="{{ route('admin.parameter.kenaikan.edit', $nilai_kenaikan->id) }}"
                                                            class="btn btn-outline-primary btn-sm me-1">
                                                            <i class="fas fa-edit me-1"></i> Edit
                                                        </a>
                                                        <form
                                                            action="{{ route('admin.parameter.kenaikan.destroy', $nilai_kenaikan->id) }}"
                                                            method="POST"
                                                            onsubmit="return confirm('Yakin ingin menghapus kenaikan ini?');">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
