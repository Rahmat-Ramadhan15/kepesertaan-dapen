    ...
    <div id="root" class="root mn--max tm--expanded-hd">
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="card p-4">
                        <h3 class="card-title text-center">Edit Kenaikan</h3>
                        <div class="card-body">
                            <form action="{{ route('admin.parameter.kenaikan.update', $kenaikan->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                    <label for="jabatan" class="form-label">Jabatan</label>
                                    <input type="text" class="form-control" id="jabatan" name="jabatan"
                                        value="{{ $kenaikan->jabatan }}" required>
                                </div>
                                <div class="mb-3">
                                    <label for="kenaikan" class="form-label">Kenaikan</label>
                                    <input type="number" class="form-control" id="kenaikan" name="kenaikan"
                                        value="{{ $kenaikan->kenaikan }}" required>
                                </div>
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-1"></i> Update
                                </button>
                                <a href="{{ route('admin.parameter.kenaikan.index') }}" class="btn btn-secondary">
