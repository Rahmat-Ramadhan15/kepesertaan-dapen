    ...
    <div class="main-content" id="mainContent">
        <div class="dashboard-container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.parameter.nsanak.update', $data->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="nilai_sekarang" name="nilai_sekarang" rows="3" step="0.000001"
                                oninput="this.value = this.value.match(/^\d*\.?\d{0,6}/)?.[0] || ''" required>{{ $data->nilai_sekarang }}</textarea>
                        </div>
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-1"></i> Update
                        </button>
                        <a href="{{ route('admin.parameter.nsanak.index') }}" class="btn btn-secondary">
