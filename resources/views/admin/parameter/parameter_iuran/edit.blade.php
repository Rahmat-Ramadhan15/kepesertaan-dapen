    ...
    <div id="root" class="root mn--max tm--expanded-hd">
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="card p-4">
                        <h3 class="card-title text-center">Parameter Iuran</h3>
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.parameter.parameter_iuran.update', $parameter->id) }}">
                                @csrf
                                @method('PUT')

                                <div class="mb-3">
                                    <label class="form-label">Persentase Peserta</label>
                                    <input type="number" step="0.01" max="1" name="persentase_peserta" class="form-control" value="{{ old('persentase_peserta', $parameter->persentase_peserta) }}" required>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Persentase Pemberi Kerja</label>
                                    <input type="number" step="0.01" max="1" name="persentase_pemberi_kerja" class="form-control" value="{{ old('persentase_pemberi_kerja', $parameter->persentase_pemberi_kerja) }}" required>
                                </div>

                                <button type="submit" class="btn btn-success">Simpan</button>
                                <a href="{{ route('admin.parameter.parameter_iuran.index') }}" class="btn btn-secondary">Kembali</a>
                            </form>
                        </div>
                    </div>
                </div>
