...
<head>
    ...
    <title>Edit Nilai Sekarang</title>
...
<body>
        ...
        <div class="dashboard-container">
            <div class="dashboard-header">
                <h1 class="dashboard-title">
                    <i class="fas fa-building me-2"></i> Edit Nilai Sekarang
                </h1>
            </div>
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
        <strong>Form Edit Nilai Sekarang</strong>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.parameter.nspegawai.update', $data->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="nilai_sekarang" name="nilai_sekarang" rows="3"
                    oninput="this.value = this.value.match(/^\d*\.?\d{0,6}/)?.[0] || ''" required>{{ $data->nilai_sekarang }}</textarea>
            </div>

            <div class="mb-3">
                <label for="ns_janda" class="form-label">NS Janda</label>
                <textarea class="form-control" id="ns_janda" name="ns_janda" rows="3"
                    oninput="this.value = this.value.match(/^\d*\.?\d{0,6}/)?.[0] || ''" required>{{ $data->ns_janda}}</textarea>
            </div>

            <div class="mb-3">
                <label for="ns_anak" class="form-label">NS Anak</label>
                <textarea class="form-control" id="ns_anak" name="ns_anak" rows="3"
                    oninput="this.value = this.value.match(/^\d*\.?\d{0,6}/)?.[0] || ''" required>{{ $data->ns_anak }}</textarea>
            </div>
