...
<body>
        ...
        <div class="dashboard-container">
            <div class="dashboard-header">
                <h1 class="dashboard-title">
                    <i class="fas fa-building me-2"></i> Tabel NS Pegawai 
                </h1>
                <div>
                    <a href="{{ route('admin.parameter.nspegawai.create') }}" class="btn btn-primary action-button">
                        <i class="fas fa-plus me-2"></i> Tambah Nilai Sekarang
                    </a>
                </div>
            </div>
    ...
    <table class="table table-hover">
        <thead>
            <tr>
                <th width="20%">Usia</th>
                <th width="20%">Nilai Sekarang</th>
                <th width="20%">NS Janda</th>
                <th width="20%">NS Anak</th>
                <th width="20%">Aksi</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($data as $NSPegawai)
                <tr>
                    <td class="fw-semibold">{{ $NSPegawai->usia }}</td>
                    <td>{{ $NSPegawai->nilai_sekarang }}</td>
                    <td>{{ $NSPegawai->ns_janda ?? '-' }}</td>
                    <td>{{ $NSPegawai->ns_anak ?? '-' }}</td>
                    <td>
                        <div class="d-flex">
                            <a href="{{ route('admin.parameter.nspegawai.edit', $NSPegawai->id) }}"
                                class="btn btn-sm btn-warning me-2">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <form action="{{ route('admin.parameter.nspegawai.destroy', $NSPegawai->id) }}"
                                method="POST"
