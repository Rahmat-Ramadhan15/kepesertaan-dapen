        ...
        <section id="content" class="content">
            <div class="content__header content__boxed overlapping">
                <div class="content__wrap">
                    ...
                    <h1 class="page-title mb-2">Tabel NS Pegawai</h1>
                    <!-- END : Page title and information -->
                    <!-- Breadcrumb -->
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">NS Pegawai</li>
                        </ol>
                    </nav>
                    <!-- END : Breadcrumb -->
                </div>
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                                    ...
                                    <!-- Tombol Add New -->
                                    <a href="{{ route('admin.parameter.nspegawai.create') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <form
                                                            action="{{ route('admin.parameter.nspegawai.destroy', $NSPegawai->id) }}"
                                                            method="POST"
