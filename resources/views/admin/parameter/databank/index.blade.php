        ...
        <div class="dashboard-container">
            <div class="dashboard-header">
                <h1 class="dashboard-title">
                    <i class="fas fa-landmark me-2"></i> Data Bank
                </h1>
                <div>
                    <a href="{{ route('admin.parameter.databank.create') }}" class="btn btn-primary action-button">
                        <i class="fas fa-plus me-2"></i> Tambah Data Bank
                    </a>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.log-activity-btn').on('click', function(e) {
                ...
                // This part requires a backend route, which is not available in this context.
                // It's kept for structural integrity based on the original file.
                /*
                $.ajax({
