        ...
        <div class="dashboard-container">
            <div class="dashboard-header">
                <h1 class="dashboard-title">
                    <i class="fas fa-landmark me-2"></i> Tambah Data Bank
                </h1>
                <div>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.parameter.databank.store') }}" method="POST">
                        @csrf

                        <div class="mb-3">
                            <label for="kode_bank" class="form-label">Kode Bank</label>
                            <input type="text" class="form-control @error('kode_bank') is-invalid @enderror" id="kode_bank" name="kode_bank" value="{{ old('kode_bank') }}" required>
                            @error('kode_bank')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kode_cabang') is-invalid @enderror" id="kode_cabang" name="kode_cabang" value="{{ old('kode_cabang') }}" required>
                            @error('kode_cabang')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_cabang') is-invalid @enderror" id="nama_cabang" name="nama_cabang" value="{{ old('nama_cabang') }}" required>
                            @error('nama_cabang')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kode_full') is-invalid @enderror" id="kode_full" name="kode_full" value="{{ old('kode_full') }}" required>
                            @error('kode_full')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
