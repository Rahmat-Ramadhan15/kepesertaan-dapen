    ...
    <div id="root" class="root mn--max tm--expanded-hd">
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="card p-4">
                        <h3 class="card-title text-center">Edit Bank</h3>
                        <div class="card-body">
                            <form action="{{ route('admin.parameter.databank.update', $databank->kode_cabang) }}"
                                method="POST">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kode_bank') is-invalid @enderror"
                                        id="kode_bank" name="kode_bank"
                                        value="{{ old('kode_bank', $databank->kode_bank) }}" required>
                                    @error('kode_bank')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_bank') is-invalid @enderror"
                                        ...
                                        value="{{ old('nama_bank', $databank->nama_bank) }}" required>
                                    @error('nama_bank')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        class="form-control @error('kode_cabang') is-invalid @enderror" id="kode_cabang"
                                        name="kode_cabang" value="{{ old('kode_cabang', $databank->kode_cabang) }}"
                                        required>
                                    @error('kode_cabang')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nama_cabang', $databank->nama_cabang) }}" required>
                                    @error('nama_cabang')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        class="form-control @error('kode_full') is-invalid @enderror" id="kode_full"
                                        name="kode_full" value="{{ old('kode_full', $databank->kode_full) }}"
                                        required>
                                    @error('kode_full')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kota') is-invalid @enderror"
                                        id="kota" name="kota" value="{{ old('kota', $databank->kota) }}">
                                    @error('kota')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kode_pos') is-invalid @enderror"
                                        ...
                                        value="{{ old('kode_pos', $databank->kode_pos) }}">
                                    @error('kode_pos')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('telepon') is-invalid @enderror"
                                        ...
                                        value="{{ old('telepon', $databank->telepon) }}">
                                    @error('telepon')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('fax') is-invalid @enderror"
                                        id="fax" name="fax" value="{{ old('fax', $databank->fax) }}">
                                    @error('fax')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        id="email" name="email" value="{{ old('email', $databank->email) }}">
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
