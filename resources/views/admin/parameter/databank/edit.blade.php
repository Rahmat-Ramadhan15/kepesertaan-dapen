...
<head>
    ...
    <style>
        ...
        /* Sidebar Styles - dummy untuk visualisasi */
        .sidebar {
            position: fixed;
            top: 0;
            left: 0;
        ...
        <div class="dashboard-container">
            <div class="dashboard-header">
                <h1 class="dashboard-title">
                    <i class="fas fa-landmark me-2"></i> Edit Data Bank
                </h1>
                <div>
                    <a href="{{ route('admin.parameter.databank.index') }}" class="btn btn-secondary action-button">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.parameter.databank.update', $databank->kode_cabang) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kode_bank') is-invalid @enderror" id="kode_bank" name="kode_bank" value="{{ old('kode_bank', $databank->kode_bank) }}" required>
                            @error('kode_bank')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_bank') is-invalid @enderror" id="nama_bank" name="nama_bank" value="{{ old('nama_bank', $databank->nama_bank) }}" required>
                            @error('nama_bank')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kode_cabang') is-invalid @enderror" id="kode_cabang" name="kode_cabang" value="{{ old('kode_cabang', $databank->kode_cabang) }}" required>
                            @error('kode_cabang')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_cabang') is-invalid @enderror" id="nama_cabang" name="nama_cabang" value="{{ old('nama_cabang', $databank->nama_cabang) }}" required>
                            @error('nama_cabang')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="kode_full" class="form-label">Kode Full</label>
                            <input type="text" class="form-control @error('kode_full') is-invalid @enderror" id="kode_full" name="kode_full" value="{{ old('kode_full', $databank->kode_full) }}" required>
                            @error('kode_full')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
