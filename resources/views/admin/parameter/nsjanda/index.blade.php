        ...
        <div class="dashboard-container">
            <div class="dashboard-header">
                <h1 class="dashboard-title">
                    <i class="fas fa-building me-2"></i> Tabel NS Janda Duda
                </h1>
                <div>
                    <a href="{{ route('admin.parameter.nsjanda.create') }}" class="btn btn-primary action-button">
    ...
    <div class="table-responsive">
        <table class="table table-hover">
            <thead>
                <tr>
                    <th width="40%">Usia</th>
                    <th width="30%">Nilai Sekarang</th>
                    <th width="30%">NS Anak</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($data as $NSJanda)
                    <tr>
                        <td class="fw-semibold">{{ $NSJanda->usia }}</td>
                        <td>{{ $NSJanda->nilai_sekarang }}</td>
                        <td>
                            <div class="d-flex justify-content-between align-items-center">
                                <span>{{ $NSJanda->ns_anak ?? '' }}</span>
                                <div class="d-flex">
                                    <a href="{{ route('admin.parameter.nsjanda.edit', $NSJanda->id) }}"
                                        class="btn btn-sm btn-warning me-2">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <form
                                        action="{{ route('admin.parameter.nsjanda.destroy', $NSJanda->id) }}"
                                        method="POST"
