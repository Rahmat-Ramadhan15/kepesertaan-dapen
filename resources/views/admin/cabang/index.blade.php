                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex">
                                                <a href="{{ route('cabang.edit', $cabang->id) }}" class="btn btn-sm btn-warning me-2">
                                                    <i class="fas fa-edit"></i> Edit
                                                </a>
                                                <form action="{{ route('cabang.destroy', $cabang->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus cabang ini?');">
                                                    @csrf
                                                    @method('DELETE')
