        ...
        <section id="content" class="content">
            <div class="content__header content__boxed overlapping">
                <div class="content__wrap">
                    ...
                    <h1 class="page-title mb-2">Tabel Cabang</h1>
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                                    ...
                                    <!-- Tombol Add New -->
                                    <a href="{{ route('cabang.create') }}" class="btn btn-primary hstack gap-2">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <form
                                                            action="{{ route('cabang.destroy', $datacabang->kode_cabang) }}"
                                                            method="POST"
