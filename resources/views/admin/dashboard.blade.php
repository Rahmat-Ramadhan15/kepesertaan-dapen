        ...
        <section id="content" class="content">
            <div class="content__header content__boxed overlapping">
                <div class="content__wrap">
                    ...
                    <h1 class="page-title mb-2">Daftar Pengguna</h1>
                            ...
                            <div class="row">
                                ...
                                <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                                    ...
                                    {{-- <form action="{{ route('operator.index') }}" method="GET"
                                        ...
                                        <select name="cabang" class="form-select" style="width: auto;">
                                            ...
                                            @foreach ($listCabang as $cabang)
                                                <option value="{{ $cabang->id }}"
                                                    {{ request('cabang') == $cabang->id ? 'selected' : '' }}>
                                                    {{ $cabang->nama_cabang }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <a href="{{ route('operator.index') }}" class="btn btn-primary">
                                            <i class="fas fa-sync-alt me-1"></i> Reset
                                        </a>
                                    </form> --}}

                                    <!-- Tombol Add New -->
                                    <a href="{{ route('admin.create-operator') }}" class="btn btn-primary hstack gap-2">
                                    ...
                                    <tbody>
                                        @foreach ($users as $user)
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-left">
                                                    @if ($user->is_blocked)
                                                        <form action="{{ route('admin.unblock-user', $user->id) }}"
                                                    ...
                                                    @else
                                                        <span class="badge bg-success px-3 py-2 d-inline-block">
                                        ...
                                        @if ($users->isEmpty())
                                            <tr>
                                                <td colspan="4" class="text-center text-muted">Belum ada pengguna
                                                    terdaftar.
                                                </td>
                                            </tr>
                                        @endif
