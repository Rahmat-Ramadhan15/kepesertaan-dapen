      ...
      <section id="content" class="content">
         ...
         <div class="content__boxed">
            <div class="content__wrap">
               ...
               <h2 class="mt-5 mb-3">Hitung Iuran <span class="badge bg-info">Pensiun</span></h2>
               <section>
                  <div class="row">
                     <div class="col-md-6 mb-3">
                        <div class="card h-100">
                           <div class="card-body">
                              <h5 class="card-title">Kalkulator Iuran</h5>
...
<div class="card-body">
               ...
               <h2 class="mt-5 mb-3">Tabel Proyeksi Manfaat Berdasarkan Masa Kerja</h2>
               <section>
                  <div class="card h-100">
                     <div class="card-body">
...
<script>
    // Check if toggleSidebar exists before adding event listener
    ...
    $(document).ready(function() {
        ...
        function calculateIuran() {
            ...
            const gaji = parseFloat($('#gaji').val().replace(/\D/g, '')) || 0;
            const tunjangan = parseFloat($('#tunjangan').val().replace(/\D/g, '')) || 0;
            ...
            // Validation
            if (gaji <= 0) {
                alert('Gaji pokok harus diisi dengan benar');
                return;
            }
            
            if (usia <= 0 || usia >= usiaTarget) {
                alert('Usia saat ini harus valid dan lebih kecil dari target usia pensiun');
                return;
            }
            
            if (masaKerja < 0) {
                alert('Masa kerja tidak boleh negatif');
                return;
            }
            ...
            // Simple estimation of retirement accumulation
            ...
            if (usiaTarget < 56) {
                ...
                discountFactor = 0.94 + ((usiaTarget - 46) * 0.01);
                if (discountFactor < 0.94) discountFactor = 0.94;
            }
        ...
        function createChart(iuranPeserta, iuranPengusaha) {
            const chartCanvas = document.getElementById('chartIuran');
            if (!chartCanvas) {
            ...
            iuranChart = new Chart(ctx, {
                type: 'pie',
                data: {
                    labels: ['Iuran Peserta (2%)', `Iuran Pengusaha (${$('#persentasePengusaha').val()}%)`],
                    datasets: [{
                        ...
                        tooltip: {
                            callbacks: {
                                label: function(context) {
                                    ...
                                    const total = iuranPeserta + iuranPengusaha;
        ...
        $('#saveCalculation').on('click', function() {
            ...
            const calculationData = {
                ...
                usiaTarget: $('#usiaTarget').val(),
                persentasePengusaha: $('#persentasePengusaha').val(),
                timestamp: new Date().toISOString()
            };
            
            // Create downloadable file
            const dataStr = "data:text/json;charset=utf-8," + encodeURIComponent(JSON.stringify(calculationData, null, 2));
            const downloadAnchorNode = document.createElement('a');
            downloadAnchorNode.setAttribute("href", dataStr);
            downloadAnchorNode.setAttribute("download", "perhitungan_iuran_" + new Date().toISOString().split('T')[0] + ".json");
        ...
        $('#gaji, #tunjangan').on('input', function() {
