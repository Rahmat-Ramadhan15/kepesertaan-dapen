   ...
   <div id="root" class="root mn--max tm--expanded-hd">
      ...
      <section id="content" class="content">
         ...
         <div class="content__header content__boxed overlapping">
            ...
            <h1 class="page-title mb-0 mt-2">Edit Peserta</h1>
               <!-- Breadcrumb -->
                     ...
                     @endif
                        <form id="formEditPeserta" action="{{ route('operator.update', $peserta->nip) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="nip" name="nip" value="{{ $peserta->nip }}" >

                                <label for="nama" class="form-label fw-semibold mt-3">Nama Lengkap</label>
                                <input type="text" class="form-control " id="nama" name="nama" value="{{ $peserta->nama }}" placeholder="Masukkan nama lengkap" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control " id="tempat_lahir" name="tempat_lahir" value="{{ $peserta->tempat_lahir }}" placeholder="Tempat">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="pendidikan" name="pendidikan">
                                        ...
                                        <option value="SLTP" {{ $peserta->pendidikan == 'SLTP' ? 'selected' : '' }}>SLTP</option>
                                        <option value="SLTA" {{ $peserta->pendidikan == 'SLTA' ? 'selected' : '' }}>SLTA</option>
                                        <option value="D1" {{ $peserta->pendidikan == 'D1' ? 'selected' : '' }}>D1</option>
                                        <option value="D2" {{ $peserta->pendidikan == 'D2' ? 'selected' : '' }}>D2</option>
                                        <option value="D3" {{ $peserta->pendidikan == 'D3' ? 'selected' : '' }}>D3</option>
                                        <option value="D4" {{ $peserta->pendidikan == 'D4' ? 'selected' : '' }}>D4</option>
                                    </select>
                                </div>
                                <div class="col-md-6">
