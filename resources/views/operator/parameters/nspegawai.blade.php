...
<head>
    ...
    <title>NS Pegawai | Operator - Sulselbar</title>
        ...
        <section id="content" class="content">
            <div class="content__header content__boxed overlapping">
                <div class="content__wrap">
                    <h1 class="page-title mb-2">NS Pegawai</h1> <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('operator.parameters.nspegawai') }}">NS Pegawai</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>NS Janda</th>
                                            <th>NS Anak</th>
                                            {{-- Tidak ada kolom ID, Created At, Updated At --}}
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @forelse($nsPegawais as $nsPegawai)
                                        <tr>
                                            <td class="fw-semibold">{{ $nsPegawai->usia }}</td>
                                            <td>{{ number_format($nsPegawai->nilai_sekarang, 6, '.', ',') }}</td>
                                            <td>{{ number_format($nsPegawai->ns_janda, 6, '.', ',') }}</td>
                                            <td>{{ number_format($nsPegawai->ns_anak, 6, '.', ',') }}</td>
                                        </tr>
                                        @empty
                                        <tr>
                                            <td colspan="4" class="text-center">Tidak ada data NS Pegawai.</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
