...
<head>
    ...
    <title>Nilai Sekarang | Operator - Sulselbar</title>
        ...
        <section id="content" class="content">
            <div class="content__header content__boxed overlapping">
                <div class="content__wrap">
                    <h1 class="page-title mb-2">Nilai Sekarang</h1> <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('operator.parameters.nilaisekarang') }}">Nilai Sekarang</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="fw-semibold">{{ $nilai->usia }}</td>
                                            <td>{{ number_format($nilai->nilai_sekarang, 6, '.', ',') }}</td>
                                        </tr>
                                        @empty
                                        <tr>
                                            <td colspan="2" class="text-center">Tidak ada data Nilai Sekarang.</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
