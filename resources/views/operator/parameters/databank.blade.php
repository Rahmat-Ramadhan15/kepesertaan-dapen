...
<head>
    ...
    <title>Data Bank | Operator - Sulselbar</title>
        ...
        <section id="content" class="content">
            <div class="content__header content__boxed overlapping">
                <div class="content__wrap">
                    <h1 class="page-title mb-2">Data Bank</h1> <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('operator.parameters.databank') }}">Data Bank</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="11" class="text-center">Tidak ada data bank.</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
