...
<head>
    ...
    <title>Data Cabang | Operator - Sulselbar</title>
        ...
        <section id="content" class="content">
            <div class="content__header content__boxed overlapping">
                <div class="content__wrap">
                    <h1 class="page-title mb-2">Data Cabang</h1> <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('operator.parameters.datacabang') }}">Data Cabang</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="fw-semibold">{{ $cabang->kode_cabang }}</td>
                                            <td>{{ $cabang->nama_cabang }}</td>
                                            <td>{{ $cabang->kode_alias }}</td>
                                            <td>{{ $cabang->alamat }}</td>
                                            <td>{{ $cabang->kota }}</td>
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="9" class="text-center">Tidak ada data cabang.</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
