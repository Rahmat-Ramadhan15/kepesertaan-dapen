...
<head>
    ...
    <title>NS Anak | Operator - Sulselbar</title>
        ...
        <section id="content" class="content">
            <div class="content__header content__boxed overlapping">
                <div class="content__wrap">
                    <h1 class="page-title mb-2">NS Anak</h1> <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('operator.parameters.nsanak') }}">NS Anak</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @forelse($nsAnaks as $nsAnak)
                                        <tr>
                                            <td class="fw-semibold">{{ $nsAnak->usia }}</td>
                                            <td>{{ number_format($nsAnak->nilai_sekarang, 6, '.', ',') }}</td>
                                        </tr>
                                        @empty
                                        <tr>
                                            <td colspan="2" class="text-center">Tidak ada data NS Anak.</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
