                                ...
                                <form action="{{ route('operator.cetak.iuranpeserta.preview') }}" method="GET" class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="jenis_laporan" id="jenis_laporan" class="form-select" required>
                                            ...
                                            <option value="pk_dan_peserta">Daftar Iuran PK dan Peserta</option>
                                            <option value="daftar_peserta">Daftar Peserta</option>
                                            <option value="gabungan">Gabungan Iuran & Peserta</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" name="tahun" id="tahun" value="{{ now()->year }}" class="form-control" required>
                                    </div>
