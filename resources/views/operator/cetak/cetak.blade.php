...
<head>
   ...
   <title>Cetak | Bank - Sulselbar</title>
         ...
         <div class="content__boxed">
            ...
            <div class="content__wrap">
                <div class="d-flex justify-content-between align-items-center mt-5 mb-3">
                    <h2 class="mb-0">Form Filter Laporan</h2>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="form-check mb-2">
                                <input id="laporanUmum" class="form-check-input" type="radio" name="jenis_laporan" value="umum" checked>
                                <label for="laporanUmum" class="form-check-label">Laporan Umum Peserta</label>
                            </div>
                            <div class="form-check mb-2">
                                <input id="laporanDetail" class="form-check-input" type="radio" name="jenis_laporan" value="detail">
                                <label for="laporanDetail" class="form-check-label">Laporan Detail Peserta</label>
                            </div>
                        ...
                        <!-- Range Umur -->
                        <div class="row mb-3">
                            <label class="col-sm-3 col-form-label">Range Umur</label>
                            <div class="col-sm-9">
                            <div class="d-flex gap-2 align-items-center mb-2">
                                <input type="number" class="form-control form-control-sm" id="umurMin" min="18" max="100" value="18">
                                <span>s/d</span>
                                <input type="number" class="form-control form-control-sm" id="umurMax" min="18" max="100" value="100">
                                <span>tahun</span>
                            </div>
                            <input type="range" class="form-range" id="umurSlider" min="18" max="100" value="18">
                            </div>
                        </div>

                        <!-- Cabang -->
                        <div class="row mb-3">
                            <label for="filter_cabang" class="col-sm-3 col-form-label">Cabang</label>
                            <div class="col-sm-9">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="form-check mb-2">
                                ...
                                <label class="form-check-label" for="jenisKelaminSemua">Semua</label>
                            </div>
                            <div class="form-check mb-2">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                            <select id="filter_status_kawin" class="form-select" name="status_kawin">
                        ...
                        <!-- Range PHDP -->
                        <div class="row mb-3">
                            <label class="col-sm-3 col-form-label">Range PHDP</label>
                            <div class="col-sm-9">
                            <div class="d-flex gap-2 align-items-center mb-2">
                                ...
                                <div class="row">
                                    <div class="col-12" id="previewContent">
                                        <div class="text-center text-muted py-5">
                                            ...
                                            <h6 class="mb-1">Preview Laporan</h6>
                                            <p class="mb-0">Silakan pilih filter dan klik tombol <strong>"Preview"</strong> untuk melihat laporan.</p>
                                        </div>
                                    </div>
                                </div>
   ...
   <script>
    $(document).ready(function() {
        ...
        umurSlider.addEventListener('input', function() {
            ...
            umurMax.value = Math.min(100, parseInt(value) + 10);
        });
        ...
        function collectFilterValues() {
            return {
                ...
                status_kawin: $('#filter_status_kawin').val(),
